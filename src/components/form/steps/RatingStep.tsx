...
export default function RatingStep({ handleInputChange }: Props) {
  return (
    <>
      <div className="mb-[36px] flex aspect-square h-[50px] items-center justify-center rounded-full bg-neutral-dark-blue w-fit">
        <StarIcon />
      </div>
      <h1 className="mb-3 text-[28px] font-bold tracking-[calc(-0.5_*_0.01em)]">
        How did we do?
      </h1>
